...
//	}
	...
	public User findById(java.lang.Integer id) {
		...
		try {
			...
			User instance = (User) session.get("wz.model.User", id);
			session.flush();
			session.close();
			return instance;
		} catch (RuntimeException re) {
	...
	/* (non-Javadoc)
	 * @see wz.dao.UserDao#isExist(wz.model.User)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see wz.dao.UserDao#activeUser(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see wz.dao.UserDao#updateCode(java.lang.String, java.lang.String)
	 */
	@Override
