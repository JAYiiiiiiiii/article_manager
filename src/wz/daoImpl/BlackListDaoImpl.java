...
public class BlackListDaoImpl extends BaseHibernateDAO implements BlackListDao {
	...
	/* (non-Javadoc)
	 * @see wz.daoImpl.BlackListDao#save(wz.model.BlackList)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see wz.daoImpl.BlackListDao#getLevel(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see wz.daoImpl.BlackListDao#update(wz.model.BlackList)
	 */
	@Override
