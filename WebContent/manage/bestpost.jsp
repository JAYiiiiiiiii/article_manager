    ...
    <div class="row">
        <div class="col-xs-3">
            <ul class="nav nav-pills nav-stacked">
                ...
                <li role="presentation" class="active"><a href="<%=path%>/manage/bestpost.jsp">精华文章申请</a></li>
                  <li role="presentation"><a href="<%=path%>/manage/create_discuss.jsp">创建新文章目录</a></li>
            </ul>
        </div>
