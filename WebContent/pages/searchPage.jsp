    ...
    <div class="row">
        <div class="col-xs-3">
            <ul class="nav nav-pills nav-stacked">
                <li role="presentation" class="active"><a href="<%=path%>/pages/searchPage.jsp">按题目搜索</a></li>
                <li role="presentation"><a href="<%=path%>/pages/searchTimePage.jsp">按时间搜索</a></li>
                <li role="presentation"><a href="<%=path%>/pages/searchContentPage.jsp">按文章内容搜索</a></li>
            </ul>
            <br/>

            <form role="search" action="<%=request.getContextPath()%>/searchTitle.action">
