<%@ page language="java"  import="java.util.*,model.Article,com.cn.servlet.ShowServlet" pageEncoding="UTF-8"%>
<jsp:useBean id="ssi" class="serviceImpl.ShowServiceImpl"></jsp:useBean>
<%List articleList = ssi.listAllArticle(); %>
<%
